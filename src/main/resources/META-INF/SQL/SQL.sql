...
INSERT INTO tab_pessoa (id_pessoa, cpf, data_nasc, nome, rg, sexo, contato_id, endereco_id) VALUES (1, '397.334.938-05', '1990-02-02', 'Felipe Santos', '48.303.999-5', 'Masculino', 1, 1);
INSERT INTO tab_pessoa (id_pessoa, cpf, data_nasc, nome, rg, sexo, contato_id, endereco_id) VALUES (2, '300.400.900-08', '1992-03-02', 'João Ricardo', '40.300.900-5', 'Masculino', 2, 2);
